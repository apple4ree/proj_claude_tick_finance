...
spec_id: iter002_obi1_and_microprice_consensus
...
from chain1.primitives import microprice_dev_bps, obi_1
...
def signal(snap) -> float:
    ...
    return obi_1(snap) > 0.5 and microprice_dev_bps(snap) > 1.0
