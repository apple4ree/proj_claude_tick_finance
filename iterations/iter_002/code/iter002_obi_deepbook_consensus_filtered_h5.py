...
spec_id: iter002_obi_deepbook_consensus_filtered_h5
...
from chain1.primitives import obi_1, obi_ex_bbo, spread_bps
...
def signal(snap) -> float:
    ...
    return (obi_1(snap) > 0.7 and obi_ex_bbo(snap) > 0.3) and spread_bps(snap) < 10
