...
spec_id: iter002_full_consensus_contra_ask_h10
...
from chain1.primitives import ask_depth_concentration, obi_1, obi_ex_bbo
...
def signal(snap) -> float:
    ...
    return obi_1(snap) + obi_ex_bbo(snap) - 2 * ask_depth_concentration(snap)
