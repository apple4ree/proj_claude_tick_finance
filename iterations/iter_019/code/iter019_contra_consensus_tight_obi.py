...
spec_id: iter019_contra_consensus_tight_obi
...
from chain1.primitives import ask_depth_concentration, obi_ex_bbo
...
def signal(snap) -> float:
    ...
    return ask_depth_concentration(snap) > 0.4 and obi_ex_bbo(snap) > 0.4
