...
spec_id: iter003_obi_micro_consensus_opening
...
from chain1.primitives import microprice_dev_bps, minute_of_session, obi_1
...
def signal(snap) -> float:
    ...
    return (obi_1(snap) > 0.5 and microprice_dev_bps(snap) > 1.0) and minute_of_session(snap) < 15
