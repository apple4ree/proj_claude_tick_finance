...
spec_id: iter011_consensus_opening_gate
...
from chain1.primitives import ask_depth_concentration, minute_of_session, obi_1, obi_ex_bbo
...
def signal(snap) -> float:
    ...
    return obi_1(snap) + obi_ex_bbo(snap) - 2 * ask_depth_concentration(snap) > 1.5 and minute_of_session(snap) > 15
