...
spec_id: iter005_full_consensus_bid_shape
...
from chain1.primitives import ask_depth_concentration, bid_depth_concentration, obi_1, obi_ex_bbo
...
def signal(snap) -> float:
    ...
    return obi_1(snap) + obi_ex_bbo(snap) - 2 * ask_depth_concentration(snap) > 1.5 and bid_depth_concentration(snap) < 0.2
