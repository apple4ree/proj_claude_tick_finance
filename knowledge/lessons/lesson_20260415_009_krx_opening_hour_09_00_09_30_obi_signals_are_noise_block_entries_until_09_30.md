...
tags: [lesson, time-filter, opening-auction, OBI, KRX, market-making, universe_selection]
...
## Note -- time filter only effective on affected symbols (strat_0011)

Adding a 09:30 KST entry blackout to strat_0011 (000660+006800) produced zero change vs strat_0008 -- identical 15 roundtrips, +0.104% return, 46.7% WR. These two symbols never triggered OBI>0.35 before 09:30 in IS data. The opening-hour OBI spike problem belongs to 005930, 006400, and 051910, not to 000660/006800. Always pair a remediation (time filter, spread gate, imbalance threshold) with the universe that exhibited the pathology.
