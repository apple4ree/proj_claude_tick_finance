# Feedback — lob_run20260420_iter2_obi1_maker_fixed

        *Generated: 2026-04-20T13:36:27.244704Z* (programmatic)

        ## Spec
        - paradigm: `—`
        - symbol: `BTCUSDT,ETHUSDT,SOLUSDT`, horizon: `crypto_lob`
        - params: `{"obi_thresholds": {"BTCUSDT": 0.918997, "ETHUSDT": 0.942049, "SOLUSDT": 0.749589}, "spread_gate": true, "entry_price_mode": "bid", "entry_ttl_ticks": 30, "cancel_on_bid_drop_ticks": 3, "profit_target_bps": 1.21, "stop_loss_bps": 1.64, "trailing_stop": false, "trailing_activation_bps": 0.0, "trailing_distance_bps": 0.0, "lot_size": 1, "max_entries_per_session": 5, "max_position_per_symbol": 1}`
