...
def _metric_cards(report: dict) -> str:
    cards = [
        ...
        ("IC (Pearson)", f"{report.get('ic_pearson', 0):+.4f}"),
        ("IC (Spearman)", f"{report.get('ic_spearman', 0):+.4f}"),
        ("ICIR", f"{report.get('icir', 0):+.3f}"),
        ("IR (vs B&H)", f"{report.get('information_ratio', 0):+.3f}"),
